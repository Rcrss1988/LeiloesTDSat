...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        try {
            int idProduto = Integer.parseInt(id); // Converte a String em um int

            produtosdao.venderProduto(idProduto); // Chama o método com o ID do produto como um int
        } catch (NumberFormatException e) {
            // Lidere com a exceção se a entrada não for um número válido
            JOptionPane.showMessageDialog(null, "ID do produto inválido. Insira um número válido.");
        }
